 ...
 * @author Shai Almog
 */
public class IwEvolutionLeakMemoAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "IwEvolutionLeakMemoApp";
    ...
    private IwEvolutionLeakMemoApp mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new IwEvolutionLeakMemoAppStub());
    }
        ...
        Display.getInstance().callSerially(new Runnable() {
            ...
            public void run() {
                if(Display.getInstance().isEdt()) {
                    mainApp = new IwEvolutionLeakMemoApp();
                    mainApp.init(this);
                    mainApp.start();
